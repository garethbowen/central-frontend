...
//   if (storageLocale != null && locales.has(storageLocale)) {
...
// TODO pick locale, and load async, just like already done in translate.ts

// console.log(availableTranslations);
// const enMessages = normalizeMessages(enRaw);

// const raw = await availableTranslations[`../locales/strings_fr.json`]!();
// const frMessages = normalizeMessages(raw.default);
// import messages from '@intlify/unplugin-vue-i18n/messages'
// import en from '../locales/strings_en.json'
// const testMessages = {
//   'error_modal.body': 'hello {errorMessage}',
...
//   en: () => import('../locales/strings_en.json'),
//   // es: () => import('./locales/es.json'),
// }

const localesMap: Record<string, () => Promise<any>> = {
  en: () => import('../locales/strings_en.json?raw'),
  // es: () => import('./locales/es.json?import'),
}

// const messages: any = await locales['../locales/strings_en.json']()
const messages = await localesMap['en']();
i18n.global.setLocaleMessage('en', messages.default)
// i18n.global.locale.value = 'en';
// const messages = await import(`../locales/strings_en.json`)
